...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        choices=("fp32", "bf16"),
        default="fp32",
        help="Diffusion compute precision: fp32 or bf16 AMP. Model/VAE parameters remain FP32.",
    )
...
def main() -> None:
    ...
    from new_diffusion.predict import autocast_context, build_device, build_models, set_seed
    ...
    with torch.inference_mode(), autocast_context(device, args.compute_dtype):
    ...
    if refiner_model is not None:
        ...
        # Refiner runs in its own FP32 inference path.
        diffusion_01 = diffusion_result.float().add(1.0).mul(0.5)
